...
exports.userAuth = ( req, res, next ) =>{
    res.status(200).json({
        ...
        isAuth: true,
        name: req.user.title+ " " +req.user.first+ " " +req.user.surname,
        ...
        role: req.user.role,
        agencyName:req.user.agency_id.agencyName
    })
}
...
exports.userLogin = ( req, res, next ) => { 
    User.findOne({"login_id":req.body.login_id}).populate("location_id").populate("agency_id").exec((err,user)=>{
