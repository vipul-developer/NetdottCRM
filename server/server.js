...
//============ USER API START =============//
app.post("/api/location/register",auth,admin,locationRouter.locationRegister);
app.post("/api/agency/register",auth,admin,agencyRouter.agencyRegister);
app.post("/api/users/register",auth,admin,userRouter.userRegister);
